...
class IAFDInfos():
    ...
    def load_IAFD_performer_link(self, iafd_url: str, id: int, name: str):
        ...
        func_break=self.check_fatal_errors(errview, iafd_widget, check_status)
        if func_break:
            return
        ...
        infos=self.sex_abfrage_iafd(iafd_url, infos)
        infos=self.namen_abfrage_iafd(content, infos)
        infos=self.rasse_abfrage_iafd(content, tooltip_text, infos)
        infos=self.nation_abfrage_iafd(content, infos)
        infos=self.haar_abfrage_iafd(content, tooltip_text, infos)
        infos=self.gewicht_abfrage_iafd(content, tooltip_text, infos)
        infos=self.groesse_abfrage_iafd(content, tooltip_text, infos)
        infos=self.geburtsort_abfrage_iafd(content, tooltip_text, infos)
        infos=self.geburtstag_abfrage_iafd(content, tooltip_text, infos)
        infos=self.piercing_abfrage_iafd(content, tooltip_text, infos)
        infos=self.tattoo_abfrage_iafd(content, tooltip_text, infos)
        infos=self.aktiv_abfrage_iafd(content, tooltip_text, infos)
        infos=self.boobs_abfrage_iafd(content, tooltip_text, infos)
    ...
    def sex_abfrage_iafd(self, iafd_url, infos):
    ...
    def rasse_abfrage_iafd(self, content, tooltip_text, infos):
    ...
    def haar_abfrage_iafd(self, content, tooltip_text, infos):        
    ...
    def gewicht_abfrage_iafd(self, content, tooltip_text, infos):        
        infos["Gewicht"]=None 
    ...
    def groesse_abfrage_iafd(self, content, tooltip_text, infos):        
        infos["Groesse"]=None
    ...
    ### ------------------- Körper-Größe von IAFD bekommen ---------------------------- ###
    def geburtsort_abfrage_iafd(self, content, tooltip_text, infos):        
    ...
    def geburtstag_abfrage_iafd(self, content, tooltip_text, infos):        
    ...
    def piercing_abfrage_iafd(self, content, tooltip_text, infos):        
        infos["Piercing"]=None        
    ...
    def tattoo_abfrage_iafd(self, content, tooltip_text, infos):        
        infos["Tattoo"]=None
    ...
    def aktiv_abfrage_iafd(self, content, tooltip_text, infos):
        aktiv=""        
        infos["Aktiv"]=None
    ...
    def boobs_abfrage_iafd(self, content, tooltip_text, infos):        
        infos["Boobs"]=None 
