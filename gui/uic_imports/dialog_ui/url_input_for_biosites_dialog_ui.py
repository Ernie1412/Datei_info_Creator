# Form implementation generated from reading ui file 'e:\Python\Python_WORK\Datei_Info_Creator\gui\uic_imports\dialog_ui\url_input_for_biosites_dialog.ui'
#
...
class Ui_dialog_seturl(object):
    def setupUi(self, dialog_seturl):
        ...
        self.lnEdit_website_url.setGeometry(QtCore.QRect(10, 70, 441, 25))
        ...
        self.Btn_link_copy.setGeometry(QtCore.QRect(430, 70, 20, 20))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 100, 441, 37))
        ...
        self.Btn_close.setGeometry(QtCore.QRect(440, 0, 23, 23))
        ...
        self.lbl_bio_logo.setGeometry(QtCore.QRect(10, 10, 50, 25))
        ...
        self.chkBox_get_autom_iafd = QtWidgets.QCheckBox(parent=dialog_seturl)
        self.chkBox_get_autom_iafd.setEnabled(True)
        self.chkBox_get_autom_iafd.setGeometry(QtCore.QRect(70, 7, 311, 30))
        ...
        self.chkBox_iafd_enabled = QtWidgets.QCheckBox(parent=dialog_seturl)
        self.chkBox_iafd_enabled.setEnabled(True)
        self.chkBox_iafd_enabled.setGeometry(QtCore.QRect(70, 40, 311, 21))
        self.chkBox_iafd_enabled.setChecked(False)
    ...
    def retranslateUi(self, dialog_seturl):
        ...
        self.chkBox_get_autom_iafd.setToolTip(_translate("dialog_seturl", "Automatisch Link erstellen und webscrapen"))
        self.chkBox_get_autom_iafd.setText(_translate("dialog_seturl", "Automatisch IAFD Link erstellen und einsetzen"))
        self.chkBox_iafd_enabled.setToolTip(_translate("dialog_seturl", "IAFD Link Eintrag aktivieren/deaktivieren"))
        self.chkBox_iafd_enabled.setStatusTip(_translate("dialog_seturl", "Default aktiv"))
        self.chkBox_iafd_enabled.setText(_translate("dialog_seturl", "URL deaktivieren"))
